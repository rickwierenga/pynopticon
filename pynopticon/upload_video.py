...
def get_authenticated_service(client_secrets_file=None):
  flow = flow_from_clientsecrets(client_secrets_file or CLIENT_SECRETS_FILE,
...
def initialize_upload(youtube, title, description, category, tags, privacyStatus, file):
  tags = None
